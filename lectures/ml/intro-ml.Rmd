...
1. Digit reader- Categorical
2. Movie recommendations- continuous
3. Spam filter - categorical
4. Hospitalizations - continuous
5. Siri - categorical
...
dat %>%
        ...
        summarize(p = mean(gender == "Male")) %>%
        ggplot(aes(x = height, y = p)) +
        geom_line()
```
