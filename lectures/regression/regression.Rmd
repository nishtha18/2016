...
father.son %>% summarize(cor(sheight, fheight))
...
```{r}
R <- (sample_n( father.son, 100) %>% summarize(cor(fheight, sheight)))[1,]
R

sample_n( father.son, 100) %>% summarize(n())
```
...
B <- 10^4
class(R[1,])
X <- replicate(B, (sample_n( father.son, 25) %>% summarize(cor(fheight, sheight)))[1,] )
mean(X)
sd(X)
father.son %>% summarize(cor(fheight, sheight))
mean(X) + c(-2,2)*sd(X)
...
B <- 10^4
class(R[1,])
X <- replicate(B, (sample_n( father.son, 250) %>% summarize(cor(fheight, sheight)))[1,] )
mean(X)
sd(X)
father.son %>% summarize(cor(fheight, sheight))
mean(X) + c(-2,2)*sd(X)
